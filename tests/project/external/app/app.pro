...
QDEP_DEPENDS += Skycoder42/qdep@master/tests/packages/external/package4/package3.pri
...
package2_included: error("package1_included")
package3_included: error("package1_included")
package4_included: error("package1_included")
package5_included: error("package1_included")
